...
Twinkle.speedy.generalList = [
	...
	{
		label: wgULS('G18: 明显以恶俗为主体内容的页面', 'G18: 明顯以惡俗為主體內容的頁面'),
		value: 'g18',
		tooltip: wgULS('是指明显可以被视作为恶俗的页面，可从其语言特征、内容概要等看出。在匹配时优先使用本条为删除理由。', '是指明顯可以被視作為惡俗的頁面，可從其語言特徵、內容概要等看出。 在匹配時優先使用本條為刪除理由。')
	}
];
