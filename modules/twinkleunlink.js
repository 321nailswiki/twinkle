...
Twinkle.unlink.callback = function(presetReason) {
	...
	Window.addFooterLink(wgULS('链入设置', '連入設定'), 'TW/PREF#unlink');
	Window.addFooterLink(wgULS('Twinkle帮助', 'Twinkle說明'), 'TW/DOC#unlink');
			...
			if (apiobj.params.image) {
				...
				if (!list.length) {
					...
					apiobj.params.form.append({
						...
						tooltip: wgULS('您可在Twinkle属性中更改这个，请参见[[TWPREFS]]', '您可在Twinkle屬性中更改這個，請參見[[TWPREFS]]')
					});
