...
Twinkle.stub.callback = function friendlytagCallback() {
	...
	Window.addFooterLink('小作品說明', 'Project:小作品');
	Window.addFooterLink(wgULS('小作品设置', '小作品設定'), 'TW/PREF#stub');
	Window.addFooterLink(wgULS('Twinkle帮助', 'Twinkle說明'), 'TW/DOC#stub');
	...
	switch (Twinkle.stub.mode) {
		...
		case '条目':
			...
			form.append({
				...
				tooltip: wgULS('您可以在Twinkle参数设置（TWPREFS）中更改此项。', '您可以在Twinkle偏好設定（TWPREFS）中更改此項。'),
